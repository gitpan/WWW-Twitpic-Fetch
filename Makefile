# This Makefile is for the WWW::Twitpic::Fetch extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/WWW/Twitpic/Fetch.pm]
#     AUTHOR => q[turugina <turugina@cpan.org>]
#     LICENSE => q[perl]
#     NAME => q[WWW::Twitpic::Fetch]
#     PL_FILES => {  }
#     PREREQ_PM => { IO::File=>q[0], URI=>q[0], Text::Trim=>q[0], Encode=>q[0], Carp=>q[0], Test::More=>q[0], LWP::UserAgent=>q[0], Web::Scraper=>q[0], List::MoreUtils=>q[0], Moose=>q[0] }
#     VERSION_FROM => q[lib/WWW/Twitpic/Fetch.pm]
#     clean => { FILES=>q[WWW-Twitpic-Fetch-*] }
...
FULL_AR = 
LD = g++
LDDLFLAGS = -mdll -s -L"d:\perl\lib\CORE" -L"d:\MinGW\lib"
LDFLAGS = -s -L"d:\perl\lib\CORE" -L"d:\MinGW\lib"
LIBC = -lmsvcrt
LIB_EXT = .a
OBJ_EXT = .o
OSNAME = MSWin32
...
MAKE = dmake
FULLEXT = WWW\Twitpic\Fetch
BASEEXT = Fetch
PARENT_NAME = WWW::Twitpic
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WWW/Twitpic/Fetch.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)\WWW\Twitpic
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\WWW\Twitpic
...
TO_INST_PM = lib/WWW/Twitpic/Fetch.pm

PM_TO_BLIB = lib/WWW/Twitpic/Fetch.pm \
	blib\lib\WWW\Twitpic\Fetch.pm


# --- MakeMaker platform_constants section:
MM_Win32_VERSION = 6.52
...
DISTNAME = WWW-Twitpic-Fetch
DISTVNAME = WWW-Twitpic-Fetch-0.03
...
Fetch.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"WWW::Twitpic::Fetch\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	lib/WWW/Twitpic/Fetch.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WWW/Twitpic/Fetch.pm $(INST_MAN3DIR)\WWW.Twitpic.Fetch.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               WWW-Twitpic-Fetch" >> META_new.yml
	$(NOECHO) $(ECHO) "version:            0.03" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:           Moose-based information scraper/fetcher for Twitpic" >> META_new.yml
	$(NOECHO) $(ECHO) "author:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - turugina <turugina@cpan.org>" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "    Text::Trim:       0" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Moose-based information scraper/fetcher for Twitpic</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>turugina &lt;turugina@cpan.org&gt;</AUTHOR>" >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Text::Trim\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"URI::\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Web::Scraper\" />" >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/WWW/Twitpic/Fetch.pm blib\lib\WWW\Twitpic\Fetch.pm 
